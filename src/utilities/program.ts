...
const program = [
  {
    ...
    timeline: [
      ...
      {
        time: '14:30 - 16:00',
        title: `"Viva Cu Canta" - Laboratorio di Canto Popolare`,
        type: EVENT_TYPE.LABORATORIO,
        starring: [findStar('Kalura - Meridionalismo')],
      },
      {
        time: '16:00 - 17:00',
        title: `LABORATORIO DI RETROFUTURISMO`,
      ...
      {
        time: '19:00 - 21:30',
        title: `Spettacolo Teatrale "Munnuera"`,
  ...
  },
  {
    ...
    timeline: [
      {
        time: '11:00 - 13:00',
        title: '“Terra terra”: laboratorio di analisi qualitativa del suolo.',
        type: EVENT_TYPE.LABORATORIO,
      ...
      {
        time: '14:30 - 15:00',
        title: 'Spazio giocoleria',
      },
      {
        time: '15:00 - 16:00',
        title: `“Terra terra”: laboratorio di analisi qualitativa del suolo (conclusione)`,
        type: EVENT_TYPE.LABORATORIO,
        starring: [findStar('Noi ortadini')],
      },
      {
        time: '16:00 - 17:00',
        title: `"Generative People", aiutare i giovani creativi e digitali a interagire con aziende ed Enti Pubblici`,
        type: EVENT_TYPE.LABORATORIO,
        // starring: [findStar('Basilicata Creativa')],
      },
      {
        time: '17:00 - 18:00',
      ...
      {
        time: '18:00 - 19:00',
        title: `Ancora nuovi immaginari rurali`,
        type: EVENT_TYPE.CONFERENZA,
        starring: [findStar('Atomico')],
      },
      {
        time: '19:00 - 21:00',
        title: 'Il Futuro di Bosco Coste',
  ...
  },
  {
    ...
    timeline: [
      {
        time: '11:00 - 13:00',
        title: '"Alimugia e fermentazione: una terra che nutre, la sapienza che raccoglie"',
        type: EVENT_TYPE.LABORATORIO,
        // starring: [findStar('ResLab')],
      },
      {
        time: '13:00 - 14:30',
        title: 'Pausa pranzo',
      ...
      {
        time: '16:00 - 17:00',
        title: `Disobbedienza come strumento di innovazione per creare progresso: la Repubblica dei Piani Sottani`,
        type: EVENT_TYPE.DIALOGO,
      ...
      {
        time: '19:00 - 19:30',
        title: `Scopri il Movimento per l' Autocoscienza del Sud`,
        type: EVENT_TYPE.CONFERENZA,
        starring: [findStar('MAS')],
      },
      {
        time: '19:30 - 20:00',
        title: `Banchetto dei giochi`,
        type: EVENT_TYPE.LABORATORIO,
      },
      {
        time: '20:00 - 21:00',
        title: `Profondo Cielo: astrofotografia amatoriale e laboratorio stellare`,
        type: EVENT_TYPE.CONFERENZA,
        starring: [findStar('Giandomenico Mercadante')],
      },
      {
