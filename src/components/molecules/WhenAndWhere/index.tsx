...
const Index = () => {
  ...
  // Create intersection observers for each media component
  ...
  return (
    <div className={styles.whenAndWhere} ref={ref}>
        ...
        <SectionImageCTA
          ...
          imageOrVideo={
            inView ? (
              ...
              <div style={{ width: 700, height: 500, backgroundColor: 'var(--nt-green)' }} />
            )
          }
        />
      </div>
